...
const OrdersDialog = ({ isOpen, setIsOpen }: OrdersDialogProps) => {
  const [page, setPage] = useState(1);
  const pageSize = 10;
  const router = useRouter();

  const { data, isLoading } = api.users.getUserOrders.useQuery(
    {
      page,
      pageSize,
    },
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge variant="outline">
                          {order.orderItems[0]?.book.category.name}
                        </Badge>
                      </TableCell>
                      ...
                      <TableCell>
                        <ExternalLink
                          ...
                          onClick={() => {
                            setIsOpen(false);
                            router.push(
                              `/bookdetail/${order.orderItems[0]?.book.id}`,
                            );
                          }}
                        />
                      </TableCell>
